    ...
    <main className='p-3 max-w-4xl mx-auto'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row' >
        <div className='flex flex-col gap-4 flex-1 mb-20' >
          ...
          <h1 className='text-xl text-white font-semibold'>Tajuk</h1>
          ...
          <div className='flex flex-col flex-1 gap-2'>
            ...
            <div className='flex gap-4'>
              <input onChange={(e)=>setFiles(e.target.files)} className='b bg-white p-3 border  rounded w-full' type="file" id='images' accept='image/*' ></input>
